...
> Current release: **0.4.1**. Published APKs are available through GitHub
> Releases.
...
ArkMoney 0.4.1 is the current stable local-first release. Excel import is
...
> Текущая стабильная версия: **0.4.1**.
